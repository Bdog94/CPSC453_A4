...
void Colour::discretize()
{
    if ( r_ > 0.001 && r_ <= 0.2) r_= 0.2;
    if ( g_ > 0.001 && g_ <= 0.2) g_= 0.2;
    if ( b_ > 0.001 && b_ <= 0.2) b_= 0.2;


    if ( r_ > 0.2 && r_ <= 0.4) r_= 0.4;
    if ( g_ > 0.2 && g_ <= 0.4) g_= 0.4;
    if ( b_ > 0.2 && b_ <= 0.4) b_= 0.4;


    if ( r_ > 0.4 && r_ <= 0.6) r_= 0.6;
    if ( g_ > 0.4 && g_ <= 0.6) g_= 0.6;
    if ( b_ > 0.4 && b_ <= 0.6) b_= 0.6;

    if ( r_ > 0.6 && r_ <= 0.8) r_= 0.8;
    if ( g_ > 0.6 && g_ <= 0.8) g_= 0.8;
    if ( b_ > 0.6 && b_ <= 0.8) b_= 0.8;
...
bool Colour::isEpsilon()
{
    if (r_ < 0.001 || g_ < 0.001 || b_ < 0.001){
        return true;
    } else {
        return false;
    }

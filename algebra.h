...
inline double operator *(const Point4D& a, const Vector3D& b)
{
...
inline int operator *(const Point2D& a, const Point2D& b)
{
    return ( a[0] *b[0] + a[1] * b[1]);
}

inline Point2D operator *(const int a, const Point2D& b)
{
    return Point2D(a * b[0], a *b[1]);
}
...
{
    return Point4D(p[0] * M[0][0] + p[1] * M[0][1] + p[2] * M[0][2] + p[3] *M[0][3],
